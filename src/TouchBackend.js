...
export default class TouchBackend {
    constructor (manager, options = {}) {
        ...
        this.delayedExecutionTime = null;
    ...
    handleTopMoveStartDelay (e) {
		this.delayedExecutionTime = Date.now() + this.options.delay;
        this.checkTopMoveStart(e);
    }

    checkTopMoveStart (e, executeTime) {
    	if (this.delayedExecutionTime) {
	    	if (Date.now() > this.delayedExecutionTime) {
	    		this.handleTopMoveStart(e);
	    	}
	    	else {
	    		window.requestAnimationFrame(this.checkTopMoveStart.bind(this, e));
	    	}
	    }
    }
